#+TITLE: Tailscale Localsend - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle tailscale_localsend.py :mkdirp yes :padline no

* Overview

Literate implementation of the *tailscale-localsend* skill.

** Original Source

This was automatically converted from =tailscale_localsend.py=.

* Implementation

#+BEGIN_SRC python :tangle tailscale_localsend.py
#!/usr/bin/env python3
