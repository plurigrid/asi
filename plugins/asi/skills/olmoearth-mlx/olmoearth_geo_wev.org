#+TITLE: Olmoearth Mlx - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle olmoearth_geo_wev.py :mkdirp yes :padline no
...
#+BEGIN_SRC python :tangle olmoearth_geo_wev.py
#!/usr/bin/env python3
"""
