#+TITLE: Cantordust Viz - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:julia :tangle cantordust_gay_bridge.jl :mkdirp yes :padline no

* Overview

Literate implementation of the *cantordust-viz* skill.

** Original Source

This was automatically converted from =cantordust_gay_bridge.jl=.

* Implementation

#+BEGIN_SRC julia :tangle cantordust_gay_bridge.jl
#!/usr/bin/env julia
