...
#+DATE: 2026-01-07
#+PROPERTY: header-args:julia :tangle CJCarrAnalysis.jl :mkdirp yes :padline no
...
This was automatically converted from =CJCarrAnalysis.jl=.

* Implementation

#+BEGIN_SRC julia :tangle CJCarrAnalysis.jl
#!/usr/bin/env julia
