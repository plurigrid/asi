#+TITLE: Tenderloin - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle full_funding_cycle.py :mkdirp yes :padline no

* Overview

Literate implementation of the *tenderloin* skill.

** Original Source

This was automatically converted from =full_funding_cycle.py=.

* Implementation

#+BEGIN_SRC python :tangle full_funding_cycle.py
#!/usr/bin/env python3
"""
