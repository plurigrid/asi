#+TITLE: Ducklake Walk - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle demo_interleaving.py :mkdirp yes :padline no
...
#+BEGIN_SRC python :tangle demo_interleaving.py
#!/usr/bin/env python3
"""
