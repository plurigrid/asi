#+TITLE: Dynamic Sufficiency - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle max_fanout_gadget.py :mkdirp yes :padline no
...
This was automatically converted from =max_fanout_gadget.py=.

* Implementation

#+BEGIN_SRC python :tangle max_fanout_gadget.py
"""
