...
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle world_memory.py :mkdirp yes :padline no
...
This was automatically converted from =world_memory.py=.

* Implementation

#+BEGIN_SRC python :tangle world_memory.py
"""
