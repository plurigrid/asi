#+TITLE: Org Babel Execution - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:julia :tangle convert_to_literate.jl :mkdirp yes :padline no
...
#+BEGIN_SRC julia :tangle convert_to_literate.jl
#!/usr/bin/env julia
