#+TITLE: Glass Hopping - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle synthesis_demo.py :mkdirp yes :padline no
...
This was automatically converted from =synthesis_demo.py=.

* Implementation

#+BEGIN_SRC python :tangle synthesis_demo.py
#!/usr/bin/env python3
"""
