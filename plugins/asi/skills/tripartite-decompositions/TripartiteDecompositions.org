...
#+DATE: 2026-01-07
#+PROPERTY: header-args:julia :tangle TripartiteDecompositions.jl :mkdirp yes :padline no
...
This was automatically converted from =TripartiteDecompositions.jl=.

* Implementation

#+BEGIN_SRC julia :tangle TripartiteDecompositions.jl
