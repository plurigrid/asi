#+TITLE: Plr Thread Coloring - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle plr_thread.py :mkdirp yes :padline no
...
#+BEGIN_SRC python :tangle plr_thread.py
#!/usr/bin/env python3
"""
