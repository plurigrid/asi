#+TITLE: Ordered Locale Fanout - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle ordered_locale_fanout.py :mkdirp yes :padline no

* Overview

Literate implementation of the *ordered-locale-fanout* skill.

** Original Source

This was automatically converted from =ordered_locale_fanout.py=.

* Implementation

#+BEGIN_SRC python :tangle ordered_locale_fanout.py
#!/usr/bin/env python3
"""
