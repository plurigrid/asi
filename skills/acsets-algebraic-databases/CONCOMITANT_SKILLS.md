...
- `ergodic-coordinator` — sibling in the categorical cybernetics — parametrised optics & bidirectional learners cluster — Completes the GF(3) triad: +1 + (-1) + 0 = 0
...
- `hogwash-removal` — sibling in the categorical cybernetics — parametrised optics & bidirectional learners cluster — Audit code and documentation for mathematical cargo culting, inflated claims, and categor…
...
- `structured-decompositions` — sibling in the attributed C sets — category theoretic relational data (AlgebraicJulia) cluster — Functorial structured decompositions for compositional problem solving via sheaf theoreti…
- `structured-decompositions-jl` — sibling in the attributed C sets — category theoretic relational data (AlgebraicJulia) cluster — Use when users ask about StructuredDecompositions.jl, structured decompositions,
