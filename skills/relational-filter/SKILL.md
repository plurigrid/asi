...
description: "Evaluates messages and actions against 23 empirically-grounded relational norms from Miller's Intimate Relationships (9th ed). Returns relational assessments for communication filtering, conflict pattern analysis, and trust erosion detection."
trit: -1
---
