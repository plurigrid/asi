#+TITLE: L Space - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle causality_graph.py :mkdirp yes :padline no
...
#+BEGIN_SRC python :tangle causality_graph.py
#!/usr/bin/env python3
"""
