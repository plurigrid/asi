...
python3 skills/onesec-wda/scripts/onesec_setup.py --test

# Run for all apps
python3 skills/onesec-wda/scripts/onesec_setup.py
```

Script location: `skills/onesec-wda/scripts/onesec_setup.py`
