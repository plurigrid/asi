#+TITLE: Unison Acset - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle color_world_package.py :mkdirp yes :padline no
...
#+BEGIN_SRC python :tangle color_world_package.py
#!/usr/bin/env python3
"""
