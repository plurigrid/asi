...
|--------------|-------|------|-----------|
| `aptos-labs` | Move runtime | 0 | aptos-core, aptos-wallet |
| `MystenLabs` | Sui Move | 0 | sui, sui-move |
| `move-language` | Spec/VM | 0 | move |
| `otter-sec` | Security audit | -1 | solana-verify |
| `openzeppelin` | Contracts | -1 | openzeppelin-contracts |
| `sherlock-protocol` | Audit platform | -1 | sherlock-v2-core |
| `code4rena` | Audit contests | -1 | code-contests |
| `consensys` | Enterprise | 0 | quorum |
| `daostack` | DAO framework | +1 | arc, alchemy |
| `aragon` | DAO infra | +1 | aragon-core |
...
| Author | Role | Repos |
|--------|------|-------|
| `aptos-labs/security` | Core team | aptos-core security |
| `MoveBit` | Audit firm | move-lint |
| `zellic-audit` | Security auditor | Move audits |
| `OtterSec` | Audit firm | Various |
...
- `bmorphism-interactome` - Core bmorphism network
- `gh-interactome` - General GitHub network discovery
- `aptos-agent` - Aptos blockchain interaction
- `acsets-algebraic-databases` - ACSet patterns for graph data
