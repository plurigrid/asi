...
- `diffdock` — builds on — Diffusion based molecular docking.
...
- `torchdrug` — builds on — Graph based drug discovery toolkit.
- `uniprot-database` — builds on — Direct REST API access to UniProt.
- `vertex-ai` — builds on — Google Vertex AI via gcloud OAuth2.
- `vertex-asi-interleave` — sibling in the skill routing & dispatch cluster — Interleave layer between Google Vertex AI skills and plurigrid asi capabilities.
