...
- `agent-protocol-interleave` — sibling in the Spritely distributed object capability programming (CapTP OCapN) cluster — Bridge layer connecting the emerging agentic coordination protocol ecosystem (MCP, A2A, A…
