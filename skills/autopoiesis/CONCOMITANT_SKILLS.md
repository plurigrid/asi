...
- `self-learnable-worlds` — sibling in the multi agent orchestration cluster — Worlds that learn their own structure via curiosity driven exploration, compression progr…
