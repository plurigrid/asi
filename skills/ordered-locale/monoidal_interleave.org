...
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle monoidal_interleave.py :mkdirp yes :padline no
...
This was automatically converted from =monoidal_interleave.py=.

* Implementation

#+BEGIN_SRC python :tangle monoidal_interleave.py
#!/usr/bin/env python3
"""
