...
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle mcp_locale.py :mkdirp yes :padline no
...
This was automatically converted from =mcp_locale.py=.

* Implementation

#+BEGIN_SRC python :tangle mcp_locale.py
#!/usr/bin/env python3
"""
