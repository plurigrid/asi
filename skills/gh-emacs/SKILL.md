...
- GitHub runners execute `emacs --batch --eval`
...
|---------|-------|-------------|
| [elisp-check](https://github.com/leotaku/elisp-check) | ~50⭐ | GitHub Action for elisp CI |
| [actions-batch](https://github.com/alexellis/actions-batch) | 183⭐ | Time-sharing supercomputer on GH Actions |
| [consult-gh](https://github.com/armindarvish/consult-gh) | 148⭐ | Interactive gh CLI via Consult/Vertico |
| [forge](https://github.com/magit/forge) | 1.4k⭐ | Work with forges from Magit |
| [ghub](https://github.com/magit/ghub) | 158⭐ | GitHub/GitLab/Gitea API client |
...
| Command | Description |
|---------|-------------|
| `consult-gh-search-repos` | Fuzzy search repositories |
| `consult-gh-search-issues` | Search issues/PRs across repos |
| `consult-gh-search-code` | Search code with preview |
| `consult-gh-repo-clone` | Clone with completion |
| `consult-gh-repo-fork` | Fork repository |
| `consult-gh-pr-list` | List PRs for current repo |
| `consult-gh-issue-list` | List issues for current repo |
...
|---------|---------|-------------|
| `N f f` | `forge-fetch` | Fetch issues/PRs from forge |
| `N c p` | `forge-create-pullreq` | Create PR |
| `N c i` | `forge-create-issue` | Create issue |
| `N b b` | `forge-browse-dwim` | Browse at point |
| `N l i` | `forge-list-issues` | List issues |
| `N l p` | `forge-list-pullreqs` | List PRs |
...
Format: Title, Summary, Key Changes (bullet points), Testing Notes" diff)))
    (chatgpt-shell-send-to-buffer prompt)))
```
...
- [elisp-check](https://github.com/leotaku/elisp-check) - GitHub Action for elisp
- [actions-batch](https://github.com/alexellis/actions-batch) - Time-sharing on GH Actions
- [purcell/setup-emacs](https://github.com/purcell/setup-emacs) - Emacs in Actions
- [consult-gh README](https://github.com/armindarvish/consult-gh)
- [forge manual](https://magit.vc/manual/forge/)
- [ghub manual](https://magit.vc/manual/ghub/)
