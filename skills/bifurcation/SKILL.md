...
**Principle**: Qualitative change in dynamics as parameters vary

## Overview

Bifurcation is a fundamental concept in dynamical systems theory, providing tools for understanding the qualitative behavior of differential equations and flows on manifolds.

## Mathematical Definition

```
BIFURCATION: Phase space × Time → Phase space
```
...
# Bifurcation as compositional dynamical system
...
**Skill Name**: bifurcation
**Type**: Dynamical Systems / Bifurcation
**Trit**: 1 (PLUS)
