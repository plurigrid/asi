...
#+DATE: 2026-01-07
#+PROPERTY: header-args:julia :tangle ColoringFunctor.jl :mkdirp yes :padline no
...
This was automatically converted from =ColoringFunctor.jl=.

* Implementation

#+BEGIN_SRC julia :tangle ColoringFunctor.jl
