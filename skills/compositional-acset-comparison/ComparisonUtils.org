...
#+DATE: 2026-01-07
#+PROPERTY: header-args:julia :tangle ComparisonUtils.jl :mkdirp yes :padline no
...
This was automatically converted from =ComparisonUtils.jl=.

* Implementation

#+BEGIN_SRC julia :tangle ComparisonUtils.jl
