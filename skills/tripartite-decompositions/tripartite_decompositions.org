#+TITLE: Tripartite Decompositions - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle tripartite_decompositions.py :mkdirp yes :padline no
...
#+BEGIN_SRC python :tangle tripartite_decompositions.py
#!/usr/bin/env python3
"""
