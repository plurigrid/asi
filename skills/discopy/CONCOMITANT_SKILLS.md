...
- `alice-chirality` — invoked by — From Interverse transcript (Dec 12, 2025):
...
- `geb` — sibling in the categorical cybernetics — parametrised optics & bidirectional learners cluster — Anoma''s Geb: Categorical semantics via S expressions, polynomial functors
...
- `pennylane` — builds on — Cross platform Python library for quantum computing, quantum machine learning, and quantu…
...
- `quantum-music` — invoked by — Quantum computer music composition and performance using quantum circuits, ZX calculus no…
...
- `zx-calculus` — mutually referenced — Coecke's ZX calculus for quantum circuit reasoning via string diagrams with Z spiders (gr…
