#+TITLE: Zulip Cogen - Literate Implementation
#+AUTHOR: asi contributors
#+DATE: 2026-01-07
#+PROPERTY: header-args:python :tangle zulip_cogen.py :mkdirp yes :padline no
...
This was automatically converted from =zulip_cogen.py=.

* Implementation

#+BEGIN_SRC python :tangle zulip_cogen.py
#!/usr/bin/env python3
"""
